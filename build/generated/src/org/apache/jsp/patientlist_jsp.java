...
public final class patientlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <link  rel=\"stylesheet\" type=\"text/css\" href=\"css/patlistcss.css\"> \n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <nav>\n");
      ...
      out.write("                            <a href=\"adddoctor.html\" > Add Doctor </a>\n");
      ...
      out.write("                        <div class=\"ddmenu\">\n");
      out.write("                            <a href=\"addnurse.html\" > Add Nurse </a>\n");
      ...
      out.write("                        <div class=\"ddmenu\">\n");
      out.write("                            <a href=\"addpatient.html\" > Add Patient </a>\n");
      ...
      out.write("            <input type=\"text\" name=\"id\" placeholder=\"Enter User ID\">\n");
      ...
      out.write("        ");
            ...
            try {
                ...
                if(pid!=null){
                    rs = st.executeQuery("select * from patient where userid='"+pid+"'");
                }
                else if(pname!=null){
                    rs = st.executeQuery("select * from patient where firstname='"+pname+"'");
                }
                else if(pname!=null && pid!=null){
                    rs = st.executeQuery("select * from patient where firstname='"+pname+"' and userid='"+pid+"'");
                }
                else if(pname==null && pid==null){
